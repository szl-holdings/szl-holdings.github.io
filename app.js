...
(function () {
  ...
  var KB = [
    ...
    { q: /lean|theorem|proof|conjecture|lambda|\u039b|math/i,
      a: "The governance aggregator \u039b has a source-linked Lean 4 + Mathlib formalization. We state \u039b-uniqueness as Conjecture 1 \u2014 not a closed theorem. Being honest about that distinction is the point (DOI 10.5281/zenodo.20434308)." },
    { q: /killinchu|drone|uas|defense|counter/i,
      a: "Killinchu is the public counter-UAS interface at szlholdings-killinchu.hf.space/elite. Its named surface separates feed, simulation, and authority states; inspect its current evidence labels before treating any control as operational." },
    { q: /immune|matrix|hugging/i,
      a: "IMMUNE is our Verifiable-AI Defense Matrix: an append-only SHA-256 receipt chain (YAWAR) with SENTRA/GATE admission and HUKLLA tripwires. A public Hugging Face surface is named in the catalog; inspect its current provider and evidence state before relying on it." },
    ...
    { q: /regulat|eu ai act|compliance|audit|nist|record.?keep|\blaw\b/i,
      a: "EU AI Act implementation is staged, and applicable obligations and dates depend on the system and classification. SZL's receipt substrate is designed to support reconstructable logging and evidence; the official Commission framework remains the legal source of truth." },
    { q: /frontier|confidential|\btee\b|enclave|roadmap|future|next/i,
      a: "The frontier we track includes confidential-computing and TEE attestation for inference. SZL is sovereign-first today; hardware-attested inference is on the roadmap \u2014 stated honestly, not claimed as shipped." },
